...
This is the canonical operating guide for the Bot Hunter local development
...
Bot Hunter is developed with a small local team:
...
Bot Hunter detects likely bot clicks in unlabelled click-log data. That creates
two connected challenges.

First, the code must be correct. The parser, feature engineering, heuristics,
anomaly model, generated `submission.tsv`, and dashboard all need to agree.
...
| Claude Code | Specialist reviewers |
