...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .analysis-brief-panel { min-width:0; overflow:visible; }
    .analysis-brief-copy { display:grid; gap:10px; width:100%; max-width:min(920px,100%); min-width:0; }
    .analysis-brief-copy p { max-width:72ch; margin:0; color:var(--ink); font-size:15px; line-height:1.55; overflow-wrap:anywhere; }
